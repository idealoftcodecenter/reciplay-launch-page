...
const Drawer = ({children, isActive, setIsActive}:propTypes) => {
    ...
    return (
        <>
            ...
            <article className={`w-full px-[14px] fixed bottom-0 top-auto left-0 right-0 z-20 transform transition-transform duration-500 delay-200 ${isActive ? "translate-y-0" : "translate-y-full" }`}>
